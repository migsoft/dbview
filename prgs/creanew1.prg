...
DEFINE WINDOW _DBUcreadbf AT 295 , 312 WIDTH 549 HEIGHT 266 title PROGRAM+VERSION+"- Create a New DataBase Table (.dbf)" MODAL nosize nosysmenu
     ...
     DEFINE COMBOBOX _DBUfieldtype
            ...
            WIDTH  120
            HEIGHT 100
            ITEMS {"Character","Numeric","Date","Logical","Memo","AutoInc"}
            VALUE 1
...
if _DBUcreadbf._DBUaddline.caption == "Add"
   ...
   do case
      ...
      case _DBUcreadbf._DBUfieldtype.value == 6
         aadd(_DBUstructarr,{alltrim(_DBUcreadbf._DBUfieldname.value),"+",4,0})
   endcase
   ...
   if _DBUcurline > 0
      ...
      do case
         ...
         case _DBUcreadbf._DBUfieldtype.value == 6
            _DBUstructarr[_DBUcurline] := {alltrim(_DBUcreadbf._DBUfieldname.value),"+",4,0}
      endcase
      _DBUcreadbf._DBUstruct.deleteallitems()
      for _DBUi := 1 to len(_DBUstructarr)
         do case
...
do case
   ...
   case _DBUcreadbf._DBUfieldtype.value == 6
      _DBUstructarr[_DBUpos] := {alltrim(_DBUcreadbf._DBUfieldname.value),"+",4,0}
endcase
_DBUcreadbf._DBUstruct.deleteallitems()
for _DBUi := 1 to len(_DBUstructarr)
   do case
...
if _DBUcreadbf._DBUfieldtype.value == 6
      _DBUcreadbf._DBUfielddecimals.value := 0
endif
return nil
...
if _DBUcurline > 0
   ...
   do case
      ...
      case _DBUstructarr[_DBUcurline,2] == "+"
         _DBUcreadbf._DBUfieldtype.value := 6
   end case
